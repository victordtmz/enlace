...
class main(modelMain.main):
    ...
    def setGlobalVariables(self):
        ...
        SELECT 
            ...
            Ciudad,
            Dependencia 
            FROM tbl_Traducciones_Procedencia
            ;
        '''
        a = '''
        --sql
        '''
        self.newRecordSql = '''
        INSERT INTO tbl_Traducciones_Procedencia (
            Pais,
            Estado,
            Ciudad,
            Dependencia
    ...
    def updateRecord(self, record): 
        ...
        sql =f'''UPDATE tbl_Traducciones_Procedencia SET 
                Pais = '{record[1]}',
                Estado = '{record[2]}',
                Ciudad = '{record[3]}',
                Dependencia = '{record[4]}'
                WHERE Id_Procedencia =  {record[0]};'''
