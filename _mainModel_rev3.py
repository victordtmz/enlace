...
#G!GLOBAL CONFIGURATION --------------------------------
    ...
    def setH1Settings(self):
        ...
        self.titleLayoutBox = qtw.QWidget()
...
#P! MAIN >>>>>>>>> MAIN >>>>>>>>>> MAIN >>>>>>>>>>> MAIN >>>>>>>>> MAIN >>>>>>>>>> MAIN >>>>>>>>> 
    def initMain(self):
    ...
    def setMainLayout(self):
        ...
        self.splitter_details = qtw.QVBoxLayout()
        ...
        self.splitter_details.addWidget(self.form)
        self.splitter_details.addWidget(self.layoutFormSaveBtnBox)
        self.splitter_details_box = qtw.QFrame()
        self.splitter_details_box.setFrameShape(qtw.QFrame.Shape.Box)
        self.splitter_details_box.setFrameShadow(qtw.QFrame.Shadow.Raised)
...
#P! FORM >>>>>>>>>> FORM >>>>>>>>>> FORM >>>>>>>>> FORM >>>>>>>>>> FORM >>>>>>>>>>> FORM >>>>>>>>>> 
    ...
    def formLayout(self):
        ...
        self.layoutFormBox.setContentsMargins(0,0,50,0)
    ...
    def formLayoutSideFilesTree(self):
        ...
        self.layoutHBox = qtw.QHBoxLayout()
        self.layoutHBox.setContentsMargins(0,0,0,0)
        self.layoutHBox.setSpacing(0)
        self.layoutHBox.addWidget(self.scrollBox,2)
        self.layoutHBox.addWidget(self.filesFolder,1)
        self.layoutHBox.setAlignment(self.filesFolder,qtc.Qt.AlignmentFlag.AlignTop)
        self.form.setLayout(self.layoutHBox)
